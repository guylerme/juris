 ...
 *
 */
public class Advogado extends Pessoa implements IAdvogado {

	private List<Contato> contatos;
	private List<Logradouro> logradouros;
	private CarteiraOab carteiraOab;
	...
	@Override
	public void setCarteiraOab(CarteiraOab carteiraOab) {
		this.carteiraOab = carteiraOab;

	}

	@Override
	public CarteiraOab getCarteiraOab() {

		return this.carteiraOab;
	}
