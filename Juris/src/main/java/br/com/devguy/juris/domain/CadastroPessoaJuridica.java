...
import br.com.devguy.juris.exceptions.CNPJInvalidoException;
import br.com.devguy.juris.exceptions.DataAberturaInvalidaException;
 ...
 *
 */
public class CadastroPessoaJuridica extends DocumentoCorporativo {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see br.com.devguy.juris.domain.DocumentoCorporativo#setNumeroDocumento(
	 * double)
	 */
	@Override
	...
	public void setNomeEmpresarial(String nomeEmpresarial) {
		this.nomeEmpresarial = nomeEmpresarial.trim();
	}
	...
	public int getNaturezaJuridica() {
		return naturezaJuridica;
	}

	public void setNaturezaJuridica(int naturezaJuridica) {
	...
	public void setDataAbertura(Date dataAbertura) throws DataAberturaInvalidaException {
		Date hoje = new Date(System.currentTimeMillis());
		if (dataAbertura.before(hoje))
